...
const CategoriesPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"productos" | "clientes" | "proveedores">(() => {
    // Establecer la pestaña activa basada en la URL, pero sin cambiar la URL
    if (location.includes("/categories/clientes")) return "clientes";
    if (location.includes("/categories/proveedores")) return "proveedores";
    return "productos"; // Por defecto o si contiene "/categories/productos"
  });
  ...
  return (
      <MainLayout>
        <div className="container mx-auto px-4 py-6">
          ...
          <p>Administra las diferentes categorías para productos, clientes y proveedores</p>
          <br></br>
